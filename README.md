...
Preproccessing allows you to use logic in the CSS code by expanding what is possible within css.
2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?
My favorite is nesting. The most trouble I get from this is variables, as I find it hard to implement.
3. How would you explain the concept of a variable to someone new to programming?
A variable is something you use to substitute or give a name to data.
4. What is the purpose of using functions in code?
Functions are meant to reduce the lines of code and organize the main blocks of code by having it written elsewhere.
5. What is a JSON data?
It is an independent language that is a subset of javascript.
